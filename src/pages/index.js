  ...
  return (
    <>
      ...
      <ContentCenter id='schools'>
        ...
        <p className='p-large'>
          We have student members, typically in Computer Science and Engineering programs, from the
          following post-secondary institutions in Calgary.
        </p>
        <CardGroup>
          <Card
            href='/#about'
            img={<img className='card-image' src='images/_uofc.png' alt='University of Calgary' />}
          />
          <Card
            href='/#about'
            img={<img className='card-image' src='images/_mru.png' alt='Mount Royal University' />}
          />
          <Card
            href='/#about'
            img={
      ...
      <ContentLeft
        id='students'
        img={<img className='img-fluid' src='images/_students.svg' alt='alternative' />}
        cta={
          <a
        ...
        <p>
          ...
          amazing experiences to put on your resume while helping your community and contributing to
          social change?
        </p>
        <p>
          ...
          non-profit organizations for the last five years. Founded at Stanford University, Code The
          Change has spread to campuses across the US and Canada.
        </p>
      </ContentLeft>
      ...
      <ContentRight
        id='causes'
        img={<img className='img-fluid' src='images/_causes.svg' alt='alternative' />}
        cta={
          <a
            className='btn-solid-reg popup-with-move-anim page-scroll'
            onClick={e => {
        ...
        <h2>For Causes</h2>
        <p>
          Code The Change is a student-led initiative where students in technology-focused programs
          volunteer their time to work on projects for causes as a way to grow their skills, gain
        ...
        <p>
          ...
          programming and software development support. We work on a wide range of projects, from
          developing web/phone apps, to RESTful web services to data collection or aggregation
          tools. We will work with you to find the right tool for the job. We prefer projects that
          are already underway with a good vision, but require a lot more technical work to move it
          along.
        </p>
        <p>
      ...
      <ContentLeft
        id='mentors'
        img={<img className='img-fluid' src='images/_mentors.svg' alt='alternative' />}
        cta={
          <a
            className='btn-solid-reg popup-with-move-anim page-scroll'
            onClick={e => {
        ...
        <p>
          Have you spent a considerable amount of time in the industry and would like to give back
          to the community?
        </p>
        <p>
      ...
      <ContentCenter id='information'>
        ...
        <p className='p-heading p-large'>
          Want to know more about upcoming events, projects, or cause registrations? <br /> Please
      ...
      <ContentCenter id='about' className='basic-4'>
        <h2>Team YYC</h2>
        <p className='p-heading p-large'>
          This is the team responsible for bringing Code The Change to life in Calgary. <br /> To
          contact them directly, please reach out via LinkedIn.
        </p>
      ...
      <ContentCenter className='form-2' id='contact'>
        ...
        <ul className='list-unstyled li-space-lg'>
          <li className='address'>
            ...
            institutions, the club needed a central place to hold events and gatherings. Benevity as
            a corporate partner graciously provides their office space for club events and meetups.
          ...
          <li>
            <i className='fas fa-map-marker-alt'></i>611 Meredith Rd NE #700, Calgary, AB T2E 2W5,
            Canada
          </li>
        </ul>
        <div className='map-responsive'>
          <iframe
            title='map'
            src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2508.0794383966327!2d-114.05320568377702!3d51.05162097956288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53717002bfa848b5%3A0xde11feaa52802a04!2sBenevity%2C%20Inc.!5e0!3m2!1sen!2sca!4v1570403455129!5m2!1sen!2sca'></iframe>
        </div>
      </ContentCenter>
    </>
  )
