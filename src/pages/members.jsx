        ...
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              ...
              <p className='p-heading p-large'>
                To accommodate our Summer 2020 project intake, we are recruiting executive roles
                with various responsibilities to aid our cause in helping non-profits.
              </p>

              <div className='m-4'>
                <h4 className='p-large'>
                  If you are interested in joining a team and working directly on a project, <br />{' '}
                  please fill out the Programmer Application Form.
                </h4>
                <a
              ...
              <div className='m-4'>
                <h4 className=' p-large'>
                  If you are interested in joining an internal admin role, <br />
